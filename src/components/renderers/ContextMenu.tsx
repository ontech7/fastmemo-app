// copied and changed from 'react-native-popup-menu' source
...
export const computePosition = (layouts: any, isRTL: boolean) => {
...
export default class ContextMenu extends React.Component<ContextMenuProps, ContextMenuState> {
  ...
  render() {
    ...
    const animation = {
      ...
      transform: [{ scaleY: this.state.scaleAnim }],
...
// public exports
(ContextMenu as any).computePosition = computePosition;
(ContextMenu as any).fitPositionIntoSafeArea = fitPositionIntoSafeArea;
