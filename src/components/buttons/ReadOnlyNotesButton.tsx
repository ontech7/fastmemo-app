...
export default function ReadOnlyNotesButton({ onPressReadOnly }: Props) {
  return (
    <TouchableOpacity activeOpacity={0.7} style={styles.readOnlyNoteButton} onPress={onPressReadOnly}>
