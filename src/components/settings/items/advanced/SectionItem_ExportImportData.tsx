...
export default function SectionItem_ExportImportData({ isLast }: Props) {
  ...
  const exportDataWeb = async (secretPassphrase: string) => {
    try {
      const exportDataObj = {
        notes: allNotes,
  ...
  const importDataWeb = async (secretPassphrase: string) => {
    try {
  ...
  const exportDataIOS = async (secretPassphrase: string) => {
    try {
      const exportData = {
        notes: allNotes,
        trashedNotes: allTrashedNotes,
  ...
  const exportData = async (secretPassphrase: string) => {
    try {
  ...
  const importData = async (secretPassphrase: string) => {
    try {
