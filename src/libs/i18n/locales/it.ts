...
• Correzioni varie.`,
  ...
  ai: {
    ...
    cap: {
      create_note: 'Creare una nota di testo — "Crea una nota su..."',
      create_todo: 'Creare una checklist — "Fammi una lista della spesa con..."',
      create_kanban: 'Creare una board kanban — "Crea un workflow con..."',
      delete_note: 'Eliminare una nota — "Elimina la nota Riunione"',
      toggle_property: 'Impostare importante/sola lettura/nascosta/protetta — "Segna Riunione come importante"',
      change_category: 'Spostare in una categoria — "Sposta Riunione in Lavoro"',
      rename_note: 'Rinominare una nota — "Rinomina Riunione in Standup"',
      add_todo_items: 'Aggiungere elementi a una lista — "Aggiungi latte alla lista della spesa"',
      summarize_note: 'Riassumere una nota — "Riassumimi la nota Riunione"',
      convert_note: 'Convertire tipo nota — "Converti Riunione in checklist"',
      merge_notes: 'Unire piu\' note — "Unisci Riunione e Appunti"',
      create_category: 'Creare una categoria — "Crea una categoria Lavoro"',
      restore_note: 'Ripristinare dal cestino — "Ripristina la nota Riunione"',
      switch_category: 'Cambiare categoria — "Vai a Lavoro" o "Mostra tutte le note"',
      change_setting: 'Modificare impostazioni — "Abilita il riconoscimento vocale"',
    },
