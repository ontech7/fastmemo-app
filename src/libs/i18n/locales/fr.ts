...
• Corrections diverses.`,
  ...
  ai: {
    ...
    cap: {
      create_note: 'Creer une note texte — "Cree une note sur..."',
      create_todo: 'Creer une liste — "Fais une liste de courses avec..."',
      create_kanban: 'Creer un tableau kanban — "Cree un workflow avec..."',
      delete_note: 'Supprimer une note — "Supprime la note Reunion"',
      toggle_property: 'Important/Lecture seule/Cache/Protege — "Marque Reunion comme important"',
      change_category: 'Deplacer dans une categorie — "Deplace Reunion dans Travail"',
      rename_note: 'Renommer une note — "Renomme Reunion en Standup"',
      add_todo_items: 'Ajouter des elements a une liste — "Ajoute du lait a la liste de courses"',
      summarize_note: 'Resumer une note — "Resume la note Reunion"',
      convert_note: 'Convertir le type de note — "Convertis Reunion en liste"',
      merge_notes: 'Fusionner des notes — "Fusionne Reunion et Notes"',
      create_category: 'Creer une categorie — "Cree une categorie Travail"',
      restore_note: 'Restaurer de la corbeille — "Restaure la note Reunion"',
      switch_category: 'Changer de categorie — "Va a Travail" ou "Montre toutes les notes"',
      change_setting: 'Modifier les parametres — "Active la reconnaissance vocale"',
    },
