...
• 其他修复。`,
  ...
  ai: {
    ...
    cap: {
      create_note: '创建文本笔记 — "创建一个关于...的笔记"',
      create_todo: '创建清单 — "创建一个包含...的购物清单"',
      create_kanban: '创建看板 — "创建一个工作流程"',
      delete_note: '删除笔记 — "删除会议笔记"',
      toggle_property: '重要/只读/隐藏/保护 — "将会议标记为重要"',
      change_category: '移动到分类 — "将会议移动到工作"',
      rename_note: '重命名笔记 — "将会议重命名为站会"',
      add_todo_items: '添加清单项目 — "将牛奶添加到购物清单"',
      summarize_note: '摘要笔记 — "摘要会议笔记"',
      convert_note: '转换笔记类型 — "将会议转换为清单"',
      merge_notes: '合并笔记 — "合并会议和笔记"',
      create_category: '创建分类 — "创建工作分类"',
      restore_note: '从回收站恢复 — "恢复会议笔记"',
      switch_category: '切换分类 — "去工作" 或 "显示所有笔记"',
      change_setting: '更改设置 — "启用语音识别"',
    },
  ...
  help: {
    ...
    how_to_create_kanban_note: {
      title: "如何创建看板笔记？",
      text_1_0: "您可以通过点击主页右下角的",
      text_1_1: '按钮并选择"看板"来创建看板笔记。',
      text_2_0: "将出现一个新页面，其中已创建一列。",
      text_3_0: '• 添加列：点击右侧的"添加列"按钮（最多5列）。',
      text_4_0: "• 重命名列：编辑列标题中的文本。",
      text_5_0: "• 更改列的颜色：点击标题中的彩色方块。",
      text_6_0: '• 添加卡片：点击列底部的"添加卡片"。',
      text_7_0: "• 移动卡片：长按卡片并将其拖动到另一列。",
      text_8_0: "• 删除卡片：点击卡片上的垃圾桶图标。",
      text_9_0: "• 删除列：点击列标题中的垃圾桶图标。",
      text_10_0: "您可以通过返回主页来保存笔记。",
    },
    how_to_edit_note: {
      title: "如何编辑笔记？",
