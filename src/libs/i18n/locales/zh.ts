...
• 其他修复。`,
  ...
  help: {
    title: "帮助",
    search_placeholder: "我们能帮您什么？",
    no_results: "没有结果，请尝试其他词语。",
    cat_notes: "笔记",
    cat_editor: "编辑器与格式",
    cat_categories: "分类",
    cat_trash: "回收站",
    ...
    what_ai_assistant: {
      title: "什么是AI助手？",
      text_1_0: "Fast Memo包含一个完全在设备上运行的自托管AI助手。不会向外部服务器发送任何数据。",
      text_2_0: "要设置它，请前往设置 -> AI助手，选择一个模型并下载。",
      text_3_0:
        "启用后，每个笔记编辑器中会出现一个星光按钮。点击它可以访问智能操作，如：生成标题、总结、继续写作、格式化文本、建议清单项目或建议类别。",
      text_4_0: "AI可离线工作，并支持多种语言。",
    },
  },
  report: {
    title: "报告问题",
