...
• Miscellaneous fixes.`,
  ...
  ai: {
    ...
    cap: {
      create_note: 'Create a text note — "Create a note about..."',
      create_todo: 'Create a checklist — "Make a shopping list with..."',
      create_kanban: 'Create a kanban board — "Create a workflow with..."',
      delete_note: 'Delete a note — "Delete the note Meeting"',
      toggle_property: 'Toggle important/readOnly/hidden/locked — "Mark Meeting as important"',
      change_category: 'Move note to category — "Move Meeting to Work"',
      rename_note: 'Rename a note — "Rename Meeting to Standup"',
      add_todo_items: 'Add items to a checklist — "Add milk to grocery list"',
      summarize_note: 'Summarize a note — "Summarize the note Meeting"',
      convert_note: 'Convert note type — "Convert Meeting to a checklist"',
      merge_notes: 'Merge notes — "Merge Meeting and Notes"',
      create_category: 'Create a category — "Create a Work category"',
      restore_note: 'Restore from trash — "Restore the note Meeting"',
      switch_category: 'Switch category — "Go to Work" or "Show all notes"',
      change_setting: 'Change settings — "Enable voice recognition"',
    },
  ...
  help: {
    ...
    how_to_create_kanban_note: {
      title: "How can I create a Kanban note?",
      ...
      text_7_0: "• To move a card: long press the card and drag it to another column.",
      text_8_0: "• To delete a card: click the trash icon on the card.",
      text_9_0: "• To delete a column: click the trash icon in the column header.",
      text_10_0: "You can save the note by going back to the Home page.",
    },
    how_to_edit_note: {
