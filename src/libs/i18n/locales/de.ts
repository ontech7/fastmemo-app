...
• Verschiedene Korrekturen.`,
  ...
  ai: {
    ...
    cap: {
      create_note: 'Textnotiz erstellen — "Erstelle eine Notiz ueber..."',
      create_todo: 'Checkliste erstellen — "Erstelle eine Einkaufsliste mit..."',
      create_kanban: 'Kanban-Board erstellen — "Erstelle einen Workflow mit..."',
      delete_note: 'Notiz loeschen — "Loesche die Notiz Meeting"',
      toggle_property: 'Wichtig/Schreibschutz/Versteckt/Gesperrt — "Markiere Meeting als wichtig"',
      change_category: 'In Kategorie verschieben — "Verschiebe Meeting nach Arbeit"',
      rename_note: 'Notiz umbenennen — "Benenne Meeting in Standup um"',
      add_todo_items: 'Elemente zur Liste hinzufuegen — "Fuege Milch zur Einkaufsliste hinzu"',
      summarize_note: 'Notiz zusammenfassen — "Fasse die Notiz Meeting zusammen"',
      convert_note: 'Notiztyp konvertieren — "Konvertiere Meeting in eine Checkliste"',
      merge_notes: 'Notizen zusammenfuegen — "Fuege Meeting und Notizen zusammen"',
      create_category: 'Kategorie erstellen — "Erstelle eine Kategorie Arbeit"',
      restore_note: 'Aus Papierkorb wiederherstellen — "Stelle die Notiz Meeting wieder her"',
      switch_category: 'Kategorie wechseln — "Gehe zu Arbeit" oder "Zeige alle Notizen"',
      change_setting: 'Einstellungen aendern — "Aktiviere Spracherkennung"',
    },
