const ja = {
  ...
  changelog: {
    ...
    web: {
      description_1_2_0: `• エンドツーエンド暗号化のクラウド同期：ノートはあなただけの鍵で保護されます。
• ホーム画面からすぐにメモを書ける「クイックメモ」バーを追加。
• ヘルプセクションを刷新し、AIスマート検索に対応。
• その他の修正と改善。`,
...
• 同期のたびに、ノートが正しく並び替えられるようになりました。`,
    ...
    mobile: {
      description_3_2_0: `• エンドツーエンド暗号化のクラウド同期：ノートはあなただけの鍵で保護されます。
• ホーム画面からすぐにメモを書ける「クイックメモ」バーを追加。
• ヘルプセクションを刷新し、AIスマート検索に対応。
• その他の修正と改善。`,
