...
• その他の修正。`,
  ...
  ai: {
    ...
    cap: {
      create_note: "テキストノートを作成 — 「...についてノートを作成」",
      create_todo: "チェックリストを作成 — 「...の買い物リストを作成」",
      create_kanban: "カンバンボードを作成 — 「ワークフローを作成」",
      delete_note: "ノートを削除 — 「ミーティングノートを削除」",
      toggle_property: "重要/読み取り専用/非表示/保護 — 「ミーティングを重要に設定」",
      change_category: "カテゴリに移動 — 「ミーティングを仕事に移動」",
      rename_note: "ノートの名前変更 — 「ミーティングをスタンドアップに変更」",
      add_todo_items: "リストに項目を追加 — 「買い物リストに牛乳を追加」",
      summarize_note: "ノートを要約 — 「ミーティングノートを要約」",
      convert_note: "ノートタイプを変換 — 「ミーティングをチェックリストに変換」",
      merge_notes: "ノートを統合 — 「ミーティングとメモを統合」",
      create_category: "カテゴリを作成 — 「仕事カテゴリを作成」",
      restore_note: "ゴミ箱から復元 — 「ミーティングノートを復元」",
      switch_category: "カテゴリを切替 — 「仕事に移動」または「全てのノートを表示」",
      change_setting: "設定を変更 — 「音声認識を有効にする」",
    },
  ...
  help: {
    ...
    how_to_create_kanban_note: {
      title: "カンバンノートを作成する方法",
      text_1_0: "ホームページの右下隅にある",
      text_1_1: "ボタンをクリックして「カンバン」を選択することでカンバンノートを作成できます。",
      text_2_0: "1つの列がすでに作成された新しいページが表示されます。",
      text_3_0: "• 列を追加するには：右側の「列を追加」ボタンをクリックします（最大5列）。",
      text_4_0: "• 列の名前を変更するには：列ヘッダーのテキストを編集します。",
      text_5_0: "• 列の色を変更するには：ヘッダーの色付きの四角をクリックします。",
      text_6_0: "• カードを追加するには：列の下部にある「カードを追加」をクリックします。",
      text_7_0: "• カードを移動するには：カードを長押しして別の列にドラッグします。",
      text_8_0: "• カードを削除するには：カードのゴミ箱アイコンをクリックします。",
      text_9_0: "• 列を削除するには：列ヘッダーのゴミ箱アイコンをクリックします。",
      text_10_0: "ホームページに戻ってノートを保存できます。",
    },
    how_to_edit_note: {
      title: "ノートを編集する方法",
