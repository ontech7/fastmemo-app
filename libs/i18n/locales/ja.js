...
• その他の修正。`,
    ...
    description_2_2_0: `• メモを非表示にする機能を追加しました。
...
• その他の修正。`,
  ...
  generalsettings: {
    ...
    export_popup_description:
      "ここに秘密のパスフレーズを入力してください。保存しないと、ノートを回復できなくなります。",
    import_popup_description:
      "ここに秘密のパスフレーズを入力してください。ノートをインポートするには保存してください。",
    webhooks: "Webhooks",
    wipe_data: "データを削除",
    about: "について",
  ...
  help: {
    ...
    how_to_create_note: {
      ...
      text_2_0:
        "新しいページが表示され、そこでノートのタイトルと説明を書くことができます。",
    ...
    how_to_create_todo_note: {
      ...
      text_2_0:
        "新しいページが表示され、そこでノートのタイトルとToDoリストを書くことができます。",
      text_3_0:
        "アイテムの右側の6つのドットを押すと、それを上下に移動できます。",
      text_4_0: "右側のクロスボタンでそのアイテムを削除できます。",
      text_5_0: "ボトムのボタンは次のとおりです：",
      text_6_0: "• 追加：リストに新しいToDoアイテムが追加されます。",
      text_7_0:
        "• チェック済みの非表示/表示：チェック済みのToDoアイテムが非表示/表示されます。",
      text_8_0:
        "• 全て削除：ノートに含まれるすべてのToDoアイテムが削除されます。",
    ...
    how_to_delete_note: {
      ...
      text_1_1: "をクリックします。",
      text_2_0:
        "右上隅にあると、ノートを表示するときにポップアップメニューが開きます。最初のオプションが必要なものです。",
    },
    how_to_select_notes: {
      title: "ノートを選択する方法",
      text_1_0: "ノートを長押しすることでノートを選択できます。",
      text_2_0:
        " '編集モード'に移行し、重要な操作や読み取り専用、ロックなどのさまざまなアクションが可能です。",
    },
    what_toolbar_below: {
      title: "下のツールバーは何ですか？",
      text_1_0: "ツールバーはさまざまな方法でテキストを豊かにします。",
      text_2_0:
        "• 画像：ギャラリーから画像を挿入および切り取ることができます。",
      ...
      text_10_0:
        "• コード：フォーマットされたコードを記述できるラッパーを作成できます。",
    },
    what_are_settings_note: {
      ...
      text_4_0:
        "• 保護：ノートをロックできます。有効になっていれば、コードまたは指紋が必要です。",
      text_5_0: "• 読み取り専用：ノートは変更できません。",
      text_6_0: "• カテゴリの変更：ノートのカテゴリを別のものに変更できます。",
      text_7_0:
        "• 共有：ノートのテキストを他のソーシャルアプリケーションに共有できます。",
    },
    how_create_category: {
      title: "カテゴリを作成する方法",
      ...
      text_2_1: "",
      text_3_0:
        "再度 'カテゴリの作成'ページにリダイレクトされます。名前を作成し、一意のアイコンを選択するよう求められます。",
      text_4_0: "フォームを記入した後、",
      text_4_1:
        "が右下隅に表示されます。新しいカテゴリを保存するには、それをクリックする必要があります。",
    },
    how_edit_category: {
      title: "カテゴリを編集する方法",
      text_1_0: "ホームページの左上にある",
    ...
    how_organize_categories: {
      ...
      text_1_1: "をクリックすることでカテゴリを編集できます。",
      text_2_0:
        " '整理'ページにリダイレクトされます。'整理モード'に移行するには、",
    ...
    how_delete_category: {
      title: "カテゴリを削除する方法",
      text_1_0:
        "ホームページにいるときは、カテゴリを長押しして、'編集モード'に移行できます。",
      text_2_0:
    ...
    what_are_trashed_notes: {
      title: "ゴミ箱のノートとは？",
      text_1_0:
        "ノートを削除すると、それはゴミ箱のノートに移動します。すべてのノートが一時的に移動するビンです。",
      text_2_0:
        "デフォルトでは、それらは7日間だけ続き、その後消えます。この設定は基本設定から変更できます。",
    },
    how_restore_trashed_notes: {
      ...
      text_2_0:
        "ノートを長押しして複数のノートを復元することもできます。右上のアイコン",
      text_2_1: "をクリックします。",
      text_3_0: "ポップアップが表示され、2番目のオプションが目的のものです。",
      text_4_0:
        "また、ゴミ箱にあるすべてのノートを復元することもできます。右上のアイコン",
      text_4_1: "をクリックします。",
    ...
    how_restore_delete_notes: {
      ...
      text_1_0:
        "「ごみ箱」ページにいるとき、ノートを長押しすると、「編集モード」に入り、削除したいノートを選択できます。",
      text_2_0: "右上のアイコン",
      text_2_1: "をクリックします。",
      text_3_0: "ポップアップが表示され、最初のオプションが目的のものです。",
      text_4_0:
        "また、ゴミ箱にあるすべてのノートを削除することもできます。右上のアイコン",
      text_4_1: "をクリックします。",
      text_5_0: "ポップアップが表示され、2番目のオプションが目的のものです。",
    },
    what_cloud_sync: {
      title: "クラウド同期とは何ですか？",
      text_1_0:
        "Google Firebaseアカウントを接続し、同期モードを有効にすることで、ノートを同期できます。",
      text_2_0:
        "他に何もする必要はありません。ノートはGoogle Firebaseに保存され、暗号化されます。",
    },
    what_secret_code: {
      title: "秘密コードとは何ですか？",
      text_1_0:
        "ロックされたノートには、最初にアプリを開いたときに生成した秘密コードが必要です。",
    ...
    what_import_export: {
      ...
      text_3_0:
        "デフォルトでは暗号化されます。インポートにはパスフレーズが必要です。",
    },
    what_wipe_data: {
      title: "データを消去するとは何ですか？",
      text_1_0: "すべてのノートとカテゴリを消去できます。",
      text_2_0:
        "アクションを実行するかどうかを確認するためのポップアップが表示されます。",
