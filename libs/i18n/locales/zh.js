...
• 其他修复。`,
  ...
  generalsettings: {
    ...
    export_popup_description:
      "在这里写下您的秘密密码。请记住保存它，否则您将无法恢复您的笔记。",
  ...
  help: {
    ...
    how_to_create_todo_note: {
      ...
      text_1_1: "主页右下角的按钮。",
      text_2_0:
        "它将弹出一个新页面，您可以在其中为您的笔记写上标题和待办事项文本列表。",
    ...
    how_to_select_notes: {
      ...
      text_2_0:
        "您将进入'编辑模式'，可以执行各种操作，例如删除、将它们设为重要、只读或锁定。",
    },
    what_toolbar_below: {
      title: "下面那个工具栏是什么？",
    ...
    how_create_category: {
      ...
      文本_2_1: "",
      text_3_0:
        "您将再次被重定向到'创建类别'页面。您将被要求创建一个名称并选择一个独特的图标。",
      text_4_0: "编译表单后，",
    ...
    how_edit_category: {
      ...
      text_1_1: "在主页的左上角。",
      text_2_0:
        "您将被重定向到'组织'页面。您需要选择一个类别，然后您将被再次重定向到'更新类别'页面。",
    },
    how_organize_categories: {
      ...
      text_2_1: "进入'组织模式'",
      text_3_0:
        "当点击一个分类时，他会'不编号'。您可以点击另一个分类来改变分类的顺序。",
      text_4_0: "完成后，您可以点击",
      text_4_1: "变化。",
    ...
    how_delete_category: {
      ...
      text_2_0: "如果你点击",
      text_2_1:
        "将出现一个弹出窗口，询问您是否要将类别与您的笔记一起删除，或者只是将它们转移到所有笔记。",
    },
    what_are_trashed_notes: {
      title: "什么是垃圾笔记？",
      text_1_0:
        "当删除一个笔记时，它会进入垃圾箱。这是一个所有笔记暂时存放的垃圾箱。",
      text_2_0:
        "默认情况下它们只会持续 7 天，然后就会消失。您可以从基本设置中更改此设置。",
    },
    how_restore_trashed_notes: {
      title: "如何恢复被删除的笔记？",
      text_1_0:
        "在'已删除的笔记'页面中，您可以选择一个笔记，然后会出现一个弹出窗口，询问您是否要恢复该笔记。",
      text_2_0:
        "您可以通过长按一个笔记来恢复多个笔记，并选择您想要的笔记。点击",
      text_2_1: "在右上角。",
    ...
    how_restore_delete_notes: {
      title: "如何恢复删除的笔记？",
      text_1_0:
        "在'已删除笔记'页面中，您可以长按要进入'编辑模式'的笔记，然后选择要删除的笔记。",
      text_2_0: "点击",
      text_2_1: "在右上角。",
    ...
    what_cloud_sync: {
      title: "什么是云同步？",
      text_1_0:
        "可以通过连接您的 Google Firebase 帐户并启用同步模式来同步您的笔记。",
      text_2_0:
        "您无需执行任何其他操作。您的笔记将加密存储在您的 Google Firebase 中。",
    },
    what_secret_code: {
      title: "什么是密码？",
