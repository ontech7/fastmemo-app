...
• Verschiedene Korrekturen.`,
  ...
  intro: {
    ...
    step4:
      "Erstellen Sie Ihre eigene Kategorie entsprechend Ihren Anforderungen.",
  ...
  setupcode: {
    title: "Geheim Code",
    firstCode_1:
      "Erstellen Sie einen Geheimcode, um Ihre Notizen zu verbergen.",
    ...
    error:
      "Der eingegebene Code stimmt nicht überein. Versuchen Sie es erneut.",
  },
  secretcode: {
    title: "Geheim Code",
    ...
    error:
      "Der von Ihnen eingegebene Code stimmt nicht überein. Versuchen Sie es erneut.",
  },
  firstMemo: {
  ...
  trashednotes: {
    ...
    countdown:
      "Löschen in: %{days} Tagen, %{hours} Stunden e %{minutes} Minuten",
    settings: {
  ...
  generalsettings: {
    ...
    import_popup_description:
      "Geben Sie hier Ihre geheime Passphrase ein, um Ihre Notizen zu importieren.",
    webhooks: "Webhooks",
  ...
  help: {
    ...
    how_to_create_note: {
      ...
      text_1_0:
        "Sie können eine Notiz erstellen, indem Sie unten rechts auf der Startseite auf die Schaltfläche",
      text_1_1: "klicken.",
      text_2_0:
        "Es öffnet sich eine neue Seite, auf der Sie Ihrer Notiz einen Titel und eine Beschreibung hinzufügen können.",
      text_3_0:
        "Sie können es speichern, indem Sie zur Startseite zurückkehren.",
    },
    how_to_create_todo_note: {
      ...
      text_3_0:
        "Durch Drücken der 6 Punkte rechts neben einem Element können Sie es nach oben und unten verschieben.",
      text_4_0: "Das Kreuz auf der rechten Seite löscht dieses Element.",
      text_5_0: "Die Schaltflächen unten sind:",
      text_6_0:
        "• Hinzufügen: Ein neues To-Do-Element wird zur Liste hinzugefügt.",
      text_7_0:
        "• Ein-/Ausblenden aktiviert: Es werden Aufgabenelemente ein-/ausblenden, wenn sie aktiviert sind.",
      text_8_0:
        "• Alle löschen: Alle in der Notiz vorhandenen To-Do-Elemente werden entfernt.",
      text_9_0:
        "Sie können es speichern, indem Sie zur Startseite zurückkehren.",
    },
    how_to_edit_note: {
      ...
      text_1_0:
        "Sie können eine Notiz bearbeiten, indem Sie sie auf der Startseite auswählen.",
    },
    how_to_delete_note: {
      ...
      text_2_0:
        "Es öffnet sich ein Popup-Menü. Die erste Option ist das, wonach Sie suchen.",
    },
    how_to_select_notes: {
      title: "Wie kann ich einige Notizen auswählen?",
      text_1_0:
        "Sie können Notizen auswählen, indem Sie lange auf eine Notiz drücken.",
      text_2_0:
    ...
    what_toolbar_below: {
      ...
      text_2_0:
        "• Bild: Sie können ein Bild aus Ihrer Galerie einfügen und ausschneiden.",
      ...
      text_6_0:
        "• Teilmenge: Sie können Ihren Text relativ zu Ihrem Text an einer unteren Position platzieren.",
      text_7_0:
        "• Obermenge: Sie können Ihren Text relativ zu Ihrem Text an oberster Stelle platzieren.",
      text_8_0:
        "• Aufzählungsliste: Sie können eine Aufzählungsliste erstellen.",
      text_9_0: "• Geordnete Liste: Sie können eine geordnete Liste erstellen.",
      text_10_0:
        "• Code: Sie können einen Wrapper erstellen, in den Sie formatierten Code schreiben können.",
    },
    what_are_settings_note: {
      ...
      text_6_0:
        "• Kategorie ändern: Sie können die Kategorie einer Notiz in eine andere ändern.",
      text_7_0:
        "• Teilen: Sie können den Text Ihrer Notiz mit einer anderen sozialen Anwendung teilen.",
    },
    how_create_category: {
      title: "Wie kann ich eine Kategorie erstellen?",
      text_1_0:
        "Sie können eine neue Kategorie erstellen, indem Sie auf klicken",
      text_1_1: "in der oberen linken Ecke der Startseite.",
      text_2_0:
        "Sie werden zur Seite 'Organisieren' weitergeleitet. Klicken Sie unten rechts auf ",
      text_2_1: "",
      text_3_0:
      ...
      text_4_1:
        "wird in der unteren rechten Ecke angezeigt. Sie müssen darauf klicken, um Ihre neue Kategorie zu speichern.",
    },
    how_edit_category: {
      title: "Wie kann ich eine Kategorie bearbeiten?",
      text_1_0:
        "Sie können eine Kategorie bearbeiten, indem Sie darauf klicken",
      text_1_1: "in der oberen linken Ecke der Startseite.",
      text_2_0:
    ...
    how_organize_categories: {
      ...
      text_1_1: "in der oberen linken Ecke der Startseite.",
      text_2_0:
        "Sie werden zur Seite ‚Organisieren‘ weitergeleitet. Sie müssen klicken",
      ...
      text_5_0:
        "Wenn Sie Ihre Änderungen rückgängig machen möchten, können Sie auf klicken",
      text_5_1: "",
    },
    how_delete_category: {
      title: "Wie kann ich eine Kategorie löschen?",
      text_1_0:
        "Auf der Startseite können Sie lange auf eine Kategorie drücken und gelangen so in den Bearbeitungsmodus.",
    ...
    how_restore_trashed_notes: {
      ...
      text_3_0:
        "Ein Popup erscheint und die zweite Option ist genau das, wonach Sie suchen.",
      text_4_0:
        "Sie können auch alle im Papierkorb vorhandenen Notizen wiederherstellen, indem Sie auf klicken",
    ...
    how_restore_delete_notes: {
      ...
      text_2_1: "in der oberen rechten Ecke.",
      text_3_0:
        "Ein Popup erscheint und die erste Option ist das, wonach Sie suchen.",
      text_4_0:
        "Sie können auch alle im Papierkorb vorhandenen Notizen löschen, indem Sie auf klicken",
      text_4_1: "in der oberen rechten Ecke.",
      text_5_0:
        "Ein Popup erscheint und die zweite Option ist genau das, wonach Sie suchen.",
    },
    what_cloud_sync: {
      ...
      text_2_0:
        "Sie müssen nichts weiter tun. Ihre Notizen werden verschlüsselt in Ihrer Google Firebase gespeichert.",
    },
    what_secret_code: {
    ...
    what_import_export: {
      ...
      text_2_0:
        "Durch den Export wird eine Datei in dem Ordner generiert, in dem Sie speichern möchten.",
      text_3_0:
        "Es wird standardmäßig verschlüsselt. Sie benötigen eine Passphrase, um es zu importieren.",
    },
    what_wipe_data: {
      title: "Was ist Wipe-Daten?",
      text_1_0: "Sie können alle Notizen und Kategorien löschen.",
      text_2_0:
        "Es erscheint ein Popup, in dem Sie gefragt werden, ob Sie sich bei dieser Aktion sicher sind.",
  ...
  report: {
    ...
    descriptionPlaceholder:
      "Bitte beschreiben Sie das Problem ausführlich (erforderlich)",
    deviceInfoCheckbox:
      "Für eine genauere Diagnose bitten wir Sie, uns bitte Gerätedetails bereitzustellen.",
  ...
  popup: {
    ...
    finish_organize_categories:
      "Fertigstellen, um Kategorien zu organisieren oder Ihre Änderungen rückgängig zu machen.",
  },
